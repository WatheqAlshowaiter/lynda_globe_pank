...
/**
 * rertun pages count for a given subject 
 *
 * @param int $subject_id
 * @param array $options
 * @return int $count
...
function count_pages_by_subject_id($subject_id, $options = [])
{
  ...
  // $sql = "SELECT COUNT(id) as 'count' FROM pages "; // if you want to use associative array (1/2)
  ...
  mysqli_free_result($result);
  $count  = $row[0];
  // $count  = $row['count'] ; // if you want to use associative array (2/2)
  return $count; // return a result set
}
